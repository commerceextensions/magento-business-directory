...
class CommerceExtensions_BusinessDirectory_Model_Resource_Directory_Listing_Submit_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
  protected function _construct()
  {
    $this->_init('businessdirectory/directory_listing_submit');
  }
  ...
  protected function _beforeLoad()
  {
    ...
    $this->getSelect()
         ->join(
           array('directory_table' => Mage::getSingleton('core/resource')->getTableName('businessdirectory/directory')),
           'main_table.directory_id = directory_table.directory_id',
           array('title'))
         ->joinLeft(
