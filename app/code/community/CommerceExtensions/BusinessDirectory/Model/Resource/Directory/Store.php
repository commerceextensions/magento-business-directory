...
class CommerceExtensions_BusinessDirectory_Model_Resource_Directory_Store extends Mage_Core_Model_Resource_Db_Abstract
{
  protected function _construct()
  {
    $this->_init('businessdirectory/directory_store', 'directory_id');
  }
}